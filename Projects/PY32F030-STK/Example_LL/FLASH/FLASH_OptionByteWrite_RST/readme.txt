...
3.Press the button,The RST button will function as a GPIO, and the LED will turn
  on.
4.Comment out "define OB_GPIO_PIN_MODE LL_FLASH_NRST_MODE_GPIO" and uncomment
  "#define OB_GPIO_PIN_MODE LL_FLASH_NRST_MODE_RESET". Recompile and download the
  program to the MCU.
